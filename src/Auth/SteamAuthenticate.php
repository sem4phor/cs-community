...
class SteamAuthenticate extends BaseAuthenticate
{
    ...
    public function authenticate(Request $request, Response $response)
    {
        ...
        $steamauth['apikey'] = "07A5DA78F41F32FF1A3DF737DACED598"; // Your Steam WebAPI-Key found at http://steamcommunity.com/dev/apikey
        ...
        // TODO figure out why this works only with debug calls
        debug($openid);//+
        if (!$openid->mode) {
